...
<img src="../../PIC/JAVA Spring/2. 스프링 핵심원리 - 기본편/2. ApplicatonContext 제공하는 부가기능.png" style="width:100%">
---
- 스프링 컨테이너는 JAVA, XML 을 비롯한 다양한 설정 형식을 지원한다.
<img src="../../PIC/JAVA Spring/2. 스프링 핵심원리 - 기본편/3. ApplicatonContext.png" style="width:100%">
---
- Java 는 AnnotationConfigApplicationContext 를 사용한다.
<img src="../../PIC/JAVA Spring/2. 스프링 핵심원리 - 기본편/1. BeanFactory.png" style="width:40%">
---
...
<img src="../../PIC/JAVA Spring/2. 스프링 핵심원리 - 기본편/4. BeanDefinition.png" style="width:100%">
